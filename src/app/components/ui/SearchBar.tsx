...
export const SearchBar = () => {
	return (
		<div className="relative">
			...
			<div className="w-80 h-9 bg-white/10 backdrop-blur hidden md:flex items-center justify-left rounded-3xl gap-5 px-4 cursor-pointer hover:bg-white/20 transition-all duration-200">
